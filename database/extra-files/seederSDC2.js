...
var bulk = ProductDetail.collection.initializeOrderedBulkOp();
...
//     // bulk = db.collection('productdetails').initializeOrderedBulkOp();
...
//   let mockReviews = createProducts();
//   ProductDetail.insertMany(mockReviews)
//     .then((docs) => {
//       console.log(docs);
